	...
	var ArticleForm = React.createClass({displayName: "ArticleForm",
		...
		React.createElement("form", {className: "form-horizontal"}, 
			...
			React.createElement("div", {className: "form-group"}, 
				...
				React.createElement("div", {className: "col-sm-10"}, 
					React.createElement("input", {type: "input", className: "form-control", id: "describe-input", ref: "describe-input", placeholder: "描述"})
				)
			), 
			React.createElement("div", {className: "form-group"}, 
				React.createElement("label", {htmlFor: "author", className: "col-sm-2 control-label"}, "作者"), 
				React.createElement("div", {className: "col-sm-10"}, 
					React.createElement("input", {type: "input", className: "form-control", id: "author", ref: "author", placeholder: "作者"})
				)
			), 
			React.createElement("div", {className: "form-group"}, 
				React.createElement("label", {htmlFor: "content", className: "col-sm-2 control-label"}, "内容"), 
				React.createElement("div", {className: "col-sm-10"}, 
					React.createElement("textarea", {className: "form-control", id: "content", ref: "content", placeholder: "请填写内容。。。", rows: "7"})
				)
			), 
			React.createElement("div", {className: "form-group hide code-wrapper"}, 
				...
				React.createElement("div", {className: "col-sm-10"}, 
					React.createElement("textarea", {className: "form-control", id: "code", ref: "code", placeholder: "请输入代码。。。", rows: "7"})
				)
			), 
			React.createElement("div", {className: "form-group"}, 
