		...
		React.createElement("form", {id: "article-form", className: "form-horizontal"}, 
			React.createElement("div", {className: "form-group"}, 
				...
				React.createElement("div", {className: "col-sm-10"}, 
					React.createElement("input", {type: "input", className: "form-control", id: "name-input", name: "name-input", ref: "name-input", "data-null": "false", placeholder: "标题"})
				)
			), 
			React.createElement("div", {className: "form-group"}, 
			...
			React.createElement("div", {className: "form-group"}, 
				...
				React.createElement("div", {className: "col-sm-10"}, 
					React.createElement("input", {type: "input", className: "form-control", id: "describe-input", name: "describe-input", ref: "describe-input", "data-null": "false", placeholder: "描述"})
				)
			), 
			React.createElement("div", {className: "form-group"}, 
				React.createElement("label", {htmlFor: "author", className: "col-sm-2 control-label"}, "作者"), 
				React.createElement("div", {className: "col-sm-10"}, 
					React.createElement("input", {type: "input", className: "form-control", id: "author", name: "author", ref: "author", "data-null": "false", placeholder: "作者"})
				)
			), 
			React.createElement("div", {className: "form-group"}, 
