define(['react'], function(React) {
	...
	var ArticleAuthor = React.createClass({displayName: "ArticleAuthor",
		render: function() {
			return (React.createElement("span", null, "作者：", React.createElement("span", {className: "author"}, this.props.data.author)))
		}
	});

	var ArticleTime = React.createClass({displayName: "ArticleTime",
		render: function() {
			return (React.createElement("span", null, "时间:", React.createElement("span", {className: "time"}, this.props.data.createTime)))
		}
	});
