require(['react','jquery'], function(React) {
	var ArticleForm = React.creatClass({
		render: function() {
			return (React.createElement("div", {class: "container"}, React.createElement("div", {className: "form-header"}, 
			...
			React.createElement("div", {className: "form-group"}, 
				...
				React.createElement("div", {className: "col-sm-10"}, 
					React.createElement("select", {className: "form-control"}, 
						React.createElement("option", null, "否"), 
						React.createElement("option", null, "是")
					)
				)
			), 
			React.createElement("div", {className: "form-group"}, 
