require(['react'], function(React) {
	var ArticleTitle = React.createclassName({
		render: function() {
			return(React.createElement("h5", {classNameName: "item-title"}))
		}
	});

	var ArticleDescribe = React.createclassName({
		render: function() {
	...
	var AticleTime = React.createclassName({
		render: function() {
	...
	var ArticleItem = React.createclassName({
		render: function() {
