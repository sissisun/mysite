require(['react','jqExtend','jquery'], function(React) {
	...
	var ArticleForm = React.createClass({displayName: "ArticleForm",
		...
		handleSubmit: function() {
			...
			console.log($articleForm.checkNullInput())
		...
		React.createElement("form", {id: "article-form", className: "form-horizontal"}, 
			React.createElement("div", {className: "form-group"}, 
				...
				React.createElement("div", {className: "col-sm-10"}, 
					React.createElement("input", {type: "input", className: "form-control", id: "name-input", ref: "name-input", "data-null": "false", placeholder: "标题"})
				)
			), 
			React.createElement("div", {className: "form-group"}, 
				React.createElement("label", {htmlFor: "article-type", className: "col-sm-2 control-label"}, "需要代码"), 
				React.createElement("div", {className: "col-sm-10"}, 
					React.createElement("select", {className: "form-control", ref: "article-type", defaultValue: this.state.need_code, onChange: this.handleCodeSelectChange}, 
			...
			React.createElement("div", {className: "form-group"}, 
				...
				React.createElement("div", {className: "col-sm-10"}, 
					React.createElement("input", {type: "input", className: "form-control", id: "describe-input", ref: "describe-input", "data-null": "false", placeholder: "描述"})
				)
			), 
			React.createElement("div", {className: "form-group"}, 
				React.createElement("label", {htmlFor: "author", className: "col-sm-2 control-label"}, "作者"), 
				React.createElement("div", {className: "col-sm-10"}, 
					React.createElement("input", {type: "input", className: "form-control", id: "author", ref: "author", "data-null": "false", placeholder: "作者"})
				)
			), 
			React.createElement("div", {className: "form-group"}, 
				React.createElement("label", {htmlFor: "content", className: "col-sm-2 control-label"}, "内容"), 
				React.createElement("div", {className: "col-sm-10"}, 
					React.createElement("textarea", {className: "form-control", id: "content", ref: "content", "data-null": "false", placeholder: "请填写内容。。。", rows: "7"})
				)
			), 
			React.createElement("div", {className: "form-group hide code-wrapper"}, 
				...
				React.createElement("div", {className: "col-sm-10"}, 
					React.createElement("textarea", {className: "form-control", id: "code", ref: "code", "data-null": "false", placeholder: "请输入代码。。。", rows: "7"})
				)
			), 
			React.createElement("div", {className: "form-group"}, 
